                    ...
                    @can('users index')
                        <li>
                            <a href="{{ route('users.index') }}" class="menu-item group {{ request()->is('dashboard/users*') ? 'menu-item-active' : 'menu-item-inactive' }}">
                                <svg class="{{ request()->is('dashboard/users*') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}" width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
