                ...
                <div>
                    <form action="{{ route('login.process') }}" method="POST">
                        ...
                        <div class="space-y-5">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <a href="/reset-password.html" class="text-sm text-gray-500 hover:text-sky-600 dark:text-gray-400">{{ __('Lupa kata sandi?') }}</a>
                            </div>
                            <div>
                    ...
                    <div class="mt-5">
                        <p class="mt-5 text-sm font-normal text-center text-gray-700 dark:text-gray-400">
                            {{ __('Belum punya akun?') }}
                            <a href="{{ route('register') }}" class="text-gray-500 hover:text-sky-600 dark:text-gray-400">{{ __('Mendaftar') }}</a>
                        </p>
                    </div>
                </div>
            </div>
